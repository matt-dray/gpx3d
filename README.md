...
Take a .gpx file—downloaded from Apple Health for example—and extract
the time, coordinates and elevation into an sf-class object. Optionally
plot this as a 3D object thanks to {ggrgl}.
...
Please note that the gpx3d project is released with a [Contributor Code
of
